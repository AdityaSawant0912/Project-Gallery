...
INSERT INTO `cs` (`id`, `project_name`, `project_category`, `project_field`, `project_description`, `project_image`, `project_abstract`, `project_problem_statement`, `project_methodology`, `project_objective`, `project_results`, `project_references`, `project_year`, `project_achivements`, `project_members`, `project_created_at`) VALUES
...
(71, 'sdfdsf', 'major-project', '', 'sdfsdf', 'https://i.imgur.com/FXMiDFj.jpeg', 'sdfsdf', 'sdfdsfsd', 'sdfsdfs', 'sdfsdfds', 'fsdfsdfsd', 'sdfsdfsdf', 2021, 'sdfsdfs', 'Aditya,\r\nAtharva,\r\nchinmay hel;lo', '2022-1-24');
